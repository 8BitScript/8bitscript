...
// lower case both (see web-runtime.mjs's decodeScreenCode, which decodes
// the same range). Trimmed from the original's full 128-entry table to
...
/**
 * The 8 row-bytes for an ASCII code in [32, 122], or `null` outside that
...
export function glyphRows(code) {
  if (code < 32 || code > 122) return null;
