 ...
 * (the "Hello, PET" roadmap), then the C64, the VIC-20, the C128, the X16 and the MEGA65 — beside the
 ...
 */
export const RELEASE_MACHINES = Object.freeze(['pet', 'c64', 'vic20', 'c128', 'cx16', 'mega65', 'web']);
